...
def extract_features(input_tensor):
    ...
    print(f'indices:{non_padded_indices},{non_padded_indices.shape}')
    ...
    print(f'num_features:{num_features},{num_features.shape}')
    ...
    # Extract the middle features using the determined indices
    extracted_features = tf.gather_nd(input_tensor, indices)
    print(f'extracted_features:{extracted_features},{extracted_features.shape}')
    exit()
